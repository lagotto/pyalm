...
var treeData = {"name": "", "contents": [{"name": "docs/*.md|jinja|markdown|easyhtml", "contents": [{"name": "docs/examples/*.py|idio|pycon|pyg", "contents": [{"name": "docs/examples/example.py|idio|pycon|pyg", "contents": []}]}, {"name": "docs/index.md|jinja|markdown|easyhtml", "contents": []}]}]};
